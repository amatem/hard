...
public class Level3 implements Level {
	...
	public void setBlueCircles(Array<Circle> blueCircles, TweenManager manager) {
		...
		Timeline.createSequence()
			.push(Tween.to(circle, BlueCircleAccessor.Y, baseTime).target(310 - temp / 2).ease(Linear.INOUT))
			.push(Tween.to(circle, BlueCircleAccessor.X, baseTime).target(325 + temp / 2 + temp).ease(Linear.INOUT))
			.push(Tween.to(circle, BlueCircleAccessor.X, baseTime).target(325 + temp / 2 + temp * 2).ease(Linear.INOUT))
			.push(Tween.to(circle, BlueCircleAccessor.X, baseTime).target(325 + temp / 2 + temp * 3).ease(Linear.INOUT))
			.push(Tween.to(circle, BlueCircleAccessor.Y, baseTime).target(310 - temp / 2 - temp).ease(Linear.INOUT))
			.push(Tween.to(circle, BlueCircleAccessor.Y, baseTime).target(310 - temp / 2 - temp * 2).ease(Linear.INOUT))
			.push(Tween.to(circle, BlueCircleAccessor.Y, baseTime).target(310 - temp / 2 - temp * 3).ease(Linear.INOUT))
			.push(Tween.to(circle, BlueCircleAccessor.X, baseTime).target(325 + temp / 2 + temp * 2).ease(Linear.INOUT))
			.push(Tween.to(circle, BlueCircleAccessor.X, baseTime).target(325 + temp / 2 + temp).ease(Linear.INOUT))
			.push(Tween.to(circle, BlueCircleAccessor.X, baseTime).target(325 + temp / 2).ease(Linear.INOUT))
			.push(Tween.to(circle, BlueCircleAccessor.Y, baseTime).target(310 - temp / 2 - temp * 2).ease(Linear.INOUT))
			.push(Tween.to(circle, BlueCircleAccessor.Y, baseTime).target(310 - temp / 2 - temp).ease(Linear.INOUT))
			.repeat(-1, 0f)
			.start(manager);
